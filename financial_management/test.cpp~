...
int main()
{
  ...
  //create_table();
  {
    query("{\"command\": \"get_product_info\", \"seq\": 0, \"paras\": { \"product_no\": \"FM0001\"} }");
    query("{\"command\": \"get_product_list\", \"seq\": 1, \"paras\": { \"start_time\": 1558583587, \"end_time\": 1558588321} }");
    query("{\"command\": \"booking\", \"seq\": 2, \"paras\": { \"product_no\": \"FM0001\", \"user_publickey\":\"up001\", \"amount\":0.1, \"timestamp\": 1558322863 } }");
    query("{\"command\": \"cancel_order\", \"seq\": 3, \"paras\": { \"product_no\": \"FM0001\", \"user_publickey\": \"up001\", \"order_id\": 10} }");
    query("{\"command\": \"update_order_txid\", \"seq\": 4, \"paras\": { \"product_no\": \"FM0001\", \"user_publickey\": \"up001\", \"order_id\": 15, \"txid\":\"txid011\", \"investment_return_addr\":\"ira011\"} }");
    query("{\"command\": \"order_txid_confirm\", \"seq\": 5, \"paras\": { \"txid\": \"txid011\", \"success\": \"true\", \"order_id\": 15} }");
    query("{\"command\": \"order_txid_confirm\", \"seq\": 5, \"paras\": { \"txid\": \"txid011\", \"success\": \"false\", \"order_id\": 14} }");
    query("{\"command\": \"payment_refund_success\", \"seq\": 7, \"paras\": { \"txid\": \"txid011\", \"order_id\": 15} }");
    query("{\"command\": \"collect\", \"seq\": 3, \"paras\": { \"product_no\": \"FM0001\", \"user_publickey\": \"up001\"} }");
    query("{\"command\": \"collect\", \"seq\": 3, \"paras\": { \"product_no\": \"FM0002\", \"user_publickey\": \"up001\"} }");
    query("{\"command\": \"collect\", \"seq\": 3, \"paras\": { \"product_no\": \"FM0003\", \"user_publickey\": \"up001\"} }");
    query("{\"command\": \"cancel_collection\", \"seq\": 3, \"paras\": { \"product_no\": \"FM0002\", \"user_publickey\": \"up001\"} }");
    query("{\"command\": \"get_user_collections\", \"seq\": 3, \"paras\": { \"user_publickey\": \"up001\"} }");
    query("{\"command\": \"get_order\", \"seq\": 7, \"paras\": { \"order_id\": 26} }");
    query("{\"command\": \"get_user\", \"seq\": 7, \"paras\": { \"user_publickey\": \"up001\"} }");

    query("{\"command\": \"get_orders\", \"seq\": 7, \"paras\": { \"product_no\": \"FM0001\", \"user_publickey\": \"all\", \"status\": 0, \"offset\":0, \"limit\":10 } }");
